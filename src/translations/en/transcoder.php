...
return [
    ...
    'Number of retries after a queued video encode fails. Set to 0 to disable automatic retries.' => 'Number of retries after a queued video encode fails. Set to 0 to disable automatic retries.',
    'Video encode retry delay' => 'Video encode retry delay',
    'Seconds to wait before retrying a failed queued video encode.' => 'Seconds to wait before retrying a failed queued video encode.',
    ...
    'Queue audio on asset upload' => 'Queue audio on asset upload',
    'Add newly uploaded audio Assets to Craft’s queue for background encoding.' => 'Add newly uploaded audio Assets to Craft’s queue for background encoding.',
    'Audio queue delay' => 'Audio queue delay',
    'Seconds to wait before uploaded audio starts encoding.' => 'Seconds to wait before uploaded audio starts encoding.',
    ...
    'Enable configured poster formats for automated video workflows.' => 'Enable configured poster formats for automated video workflows.',
    'Queue video posters on asset upload' => 'Queue video posters on asset upload',
    'Generate configured posters through Craft’s queue when full video encoding is not queued.' => 'Generate configured posters through Craft’s queue when full video encoding is not queued.',
